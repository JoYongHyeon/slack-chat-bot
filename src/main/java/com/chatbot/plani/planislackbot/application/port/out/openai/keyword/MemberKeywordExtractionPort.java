 ...
 */
public interface MemberKeywordExtractionPort {

    /**
     * 자연어 명령어(키워드)를 Notion 쿼리(JSON 형태)로 변환합니다.
     *
     * @param text 사용자 입력 자연어 명령 (예: "DevOps1 소속 PRO 멤버 보여줘")
     * @return     Notion DB 검색 조건을 나타내는 JSON 문자열 (ex: {"소속":"DevOps1","직책":"PRO"})
     */
